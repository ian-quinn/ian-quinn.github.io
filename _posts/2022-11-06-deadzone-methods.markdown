...
*Ritz values*, the eigenvalues of $\pmb{C}$, are approximations to the eigenvalues of $\pmb{A}$
*Ritz vectors*, the corresponding approximate eigenvectors of $\pmb{A}$, given by $\pmb{v}=\pmb{K\alpha}$

(There is a remark on the mentioned process)
...
\end{bmatrix}
$$
![[Pasted image 20220827110424.png | 500]]
